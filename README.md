...
**Builder.** I ship AI, infra, and infra-for-AI tools.
3x founder. Almost 10 years of building. 
...
- Trickery: Subagents, clean context every time, great MCPs
...
### AI/LLM
- **[claude-memory-viz](https://github.com/srijanshukla18/claude-memory-viz)** ⭐95 → memory visualization for Anthropic's Claude memory MCP.
- **[xray](https://github.com/srijanshukla18/xray)** ⭐43 → structural code intelligence for AI assistants using ast-grep.
...
- **[ita-kg](https://github.com/srijanshukla18/ita-kg)** → knowledge graph builder for Italian language learning via spaced repetition.
